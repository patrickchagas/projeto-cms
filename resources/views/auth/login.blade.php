    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
        ...
        <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-block">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                                <input id="email" type="email" class="form-control form-control-lg input-lg{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
            ...
            <div class="card-footer">
                <div class="">
                    <p class="float-sm-right text-xs-center m-0">Ainda não possui conta? <a href="/register" class="card-link">Crie</a></p>
                </div>
            </div>
        </div>
    </div>
